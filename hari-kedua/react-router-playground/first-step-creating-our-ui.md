...
**ELSE statement **jika ternyata sudah terdapat **Local Storage localData **maka hal yang pertama kita lakukan adalah variabel **item **di isi dengan data **Local Storage **kita, lalu hasil dari **inputValue **di **push **ke dalam variabel **item **dan set **localData **dengan nilai semua **item **yang ada.
